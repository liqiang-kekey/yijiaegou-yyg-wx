  ...
  return new Promise(function (resolve) {
    util.check_login_new().then((res) => {
      ...
      if (res) {
        ...
        app.globalData.isAuthModel = true;
      } else {
        appLoadStatus = 0;
        app.globalData.isAuthModel = false;
      }
...
function setNavBgColor() {
  ...
  if (navBgColor == 1 || navFontColor == 1) {
    app.util.request({
      ...
      success: function (res) {
        if (res.data.code == 0) {
          let nav_bg_color = res.data.data || '#13bb4e';
      ...
      app.util.request({
        ...
        success: function (res) {
          if (res.data.code == 0) {
            ...
            iconArr.home = list['i1'] || '/community/images/icon-tab-index.png';
            iconArr.car = list['i2'] || '/community/images/icon-tab-shop.png';
            iconArr.user = list['i3'] || '/community/images/icon-tab-me.png';
            resolve(iconArr);
          }
        }
      })
